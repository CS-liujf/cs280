...
def class_visualization_update_step(img:torch.Tensor, model:torch.nn.Module, target_y:int, l2_reg:float, learning_rate:float):
    ########################################################################
    ...
    grads_norm:torch.Tensor = img.grad / img.grad.norm()
    img.data += learning_rate * grads_norm
    img.grad.zero_()
